...
const F = {
  ink: "#1f1a1c", muted: "#8e7e84",
  pink: "#e84677", pinkSoft: "#fde2ea",
};

export default function RootNotFound() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "48px 20px", fontFamily: "inherit" }}>
