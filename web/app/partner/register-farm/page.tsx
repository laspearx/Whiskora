...
const OTHER_PETS = OTHER_SPECIES; // id เธญเธฑเธเธเธคเธฉ + label เนเธ—เธข เธเธฒเธ map เธเธฅเธฒเธ
...
export default function RegisterFarmPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!form.species) return alert('เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธเธเธเธดเธ”เธชเธฑเธ•เธงเนเธ—เธตเนเน€เธเธฒเธฐเธเธฑเธเธเธธเนเธซเธฅเธฑเธเธ”เนเธงเธขเธเธฃเธฑเธ');

    let finalSpecies = form.species;
    if (form.species === 'other') {
      if (!form.subSpecies) return alert('เธเธฃเธธเธ“เธฒเน€เธฅเธทเธญเธเธเธเธดเธ”เธชเธฑเธ•เธงเนเธ”เนเธงเธขเธเธฃเธฑเธ');
      finalSpecies = form.subSpecies === 'other' ? form.customSpecies.trim() : form.subSpecies;
      if (form.subSpecies === 'other' && !form.customSpecies.trim()) return alert('เธเธฃเธธเธ“เธฒเธฃเธฐเธเธธเธเธทเนเธญเธชเธฑเธ•เธงเนเธ”เนเธงเธขเธเธฃเธฑเธ');
    ...
    try {
      ...
      if (error) throw error;
      alert('๐ เธขเธดเธเธ”เธตเธ”เนเธงเธข! เน€เธเธดเธ”เธเธฒเธฃเนเธกเนเธซเธกเนเน€เธฃเธตเธขเธเธฃเนเธญเธขเนเธฅเนเธง');
      router.push('/partner');
      router.refresh();
    } catch (err: any) {
      alert(`เน€เธเธดเธ”เธเนเธญเธเธดเธ”เธเธฅเธฒเธ”: ${err.message || err.details}`);
      ...
      <div className="pf-page">
        <div className="pf-body">
          <div className="pf-header">
            <button className="pf-back" onClick={() => router.back()} aria-label="เธขเนเธญเธเธเธฅเธฑเธ"><Icon.ArrowLeft /></button>
            <div>
              <h1 className="pf-title">เน€เธเธดเธ”เธเธฒเธฃเนเธกเธชเธฑเธ•เธงเนเน€เธฅเธตเนเธขเธ ๐ก</h1>
              <p className="pf-sub">เธเธฒเธฃเนเธกเธเธฃเธตเธ”เธชเธฑเธ•เธงเนเน€เธฅเธตเนเธขเธเธ—เธตเนเธเนเธฒเธฃเธฑเธเน€เธเธทเนเธญเธเธเธฃเธฑเธเธชเธฑเธ•เธงเน</p>
            </div>
          </div>

          <form onSubmit={handleSubmit}>
            {/* เธฃเธนเธเธเธฒเธฃเนเธก */}
            <div className="pf-photo-wrap">
              <div className="pf-photo">
                <div className={`pf-photo-box ${imageUrl ? 'has-img' : ''}`} onClick={() => fileInputRef.current?.click()}>
                  {imageUrl ? <img src={imageUrl} alt="เธฃเธนเธเธเธฒเธฃเนเธก" /> : (uploading ? '...' : <Icon.Home />)}
                </div>
              ...
              <p className="pf-photo-hint">{uploading ? 'เธเธณเธฅเธฑเธเธญเธฑเธเนเธซเธฅเธ”...' : imageUrl ? 'เนเธ•เธฐเน€เธเธทเนเธญเน€เธเธฅเธตเนเธขเธเธฃเธนเธ' : 'เธญเธฑเธเนเธซเธฅเธ”เธฃเธนเธเธเธฒเธฃเนเธก / เนเธฅเนเธเน'}</p>
            </div>

            <div className="pf-card">
              <div className="pf-field">
                <label className="pf-label">เธเธทเนเธญเธเธฒเธฃเนเธกเธเธญเธเธเธธเธ“ <span className="pf-req">*</span></label>
                <input className="pf-input" required value={form.farmName} onChange={(e) => setForm({ ...form, farmName: e.target.value })} placeholder="เน€เธเนเธ Happy Paw Cattery" />
              </div>

              <div className="pf-field">
                <label className="pf-label">เธเธเธดเธ”เธชเธฑเธ•เธงเนเธ—เธตเนเน€เธเธฒเธฐเธเธฑเธเธเธธเน <span className="pf-req">*</span></label>
                <div className="pf-species">
                  {[{ id: 'cat', emoji: '๐ฑ', lbl: 'เนเธกเธง' }, { id: 'dog', emoji: '๐ถ', lbl: 'เธชเธธเธเธฑเธ' }, { id: 'other', emoji: '๐พ', lbl: 'เธญเธทเนเธเน' }].map((t) => (
                ...
                {form.species === 'other' && form.subSpecies === 'other' && (
                  <input className="pf-input" style={{ marginTop: 10 }} required value={form.customSpecies}
                    onChange={(e) => setForm({ ...form, customSpecies: e.target.value })} placeholder="เน€เธเนเธ เธเธดเธเธเธดเธฅเธฅเนเธฒ, เน€เธเธญเธฃเนเน€เธฃเธ—" />
                )}
              </div>

              <div className="pf-field">
                <label className="pf-label">เน€เธเธญเธฃเนเนเธ—เธฃเธจเธฑเธเธ—เน <span className="pf-req">*</span></label>
              ...
              <div className="pf-field">
                <label className="pf-label">เธฃเธฒเธขเธฅเธฐเน€เธญเธตเธขเธ”เน€เธเธดเนเธกเน€เธ•เธดเธก</label>
                <textarea className="pf-textarea" rows={3} value={form.bio} onChange={(e) => setForm({ ...form, bio: e.target.value })} placeholder="เธเธญเธเน€เธฅเนเธฒเธเธฃเธฐเธชเธเธเธฒเธฃเธ“เน เธเธงเธฒเธกเธ•เธฑเนเธเนเธ เธซเธฃเธทเธญเธชเธฒเธขเธเธฑเธเธเธธเนเธ—เธตเนเน€เธเธฒเธฐ..." />
              </div>
            </div>
          </form>
        </div>
        ...
        <div className="pf-savebar">
          <div className="pf-savebar-inner">
            <button type="button" className="pf-btn" onClick={handleSubmit} disabled={loading || uploading}>
              {loading ? 'โณ เธเธณเธฅเธฑเธเธเธฑเธเธ—เธถเธ...' : '๐ก เธขเธทเธเธขเธฑเธเธเธฒเธฃเน€เธเธดเธ”เธเธฒเธฃเนเธก'}
            </button>
          </div>
        </div>
      </div>
