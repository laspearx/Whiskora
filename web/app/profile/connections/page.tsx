      ...
      <div className="cn-page">
        <div className="cn-body">
          <div className="cn-header">
            <Link href="/profile/settings" className="cn-back" aria-label="ย้อนกลับ">
                ...
                {PROVIDERS.map(({ id, name, Icon, bg, iconBg }) => {
                  ...
                  return (
                    <div key={id} className="cn-row">
                      <div className="cn-icon-wrap" style={{ background: id === 'custom:line-login' ? '#fff' : linked ? '#F8F9FA' : F.line }}>
                        <Icon />
                      </div>
