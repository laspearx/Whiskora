          ...
          {(pet.status === 'พร้อมย้ายบ้าน') && (
            <div className="mt-8 pt-6 border-t border-gray-100 animate-in slide-in-from-bottom-4">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <p className="text-gray-500 font-bold text-sm">ค่าตัว / สินสอด</p>
                  <p className="text-[10px] text-pink-400 font-bold">น้องพร้อมย้ายบ้านแล้ว!</p>
                </div>
              ...
              <button 
                onClick={() => {
                   // อนาคตชัชสามารถแก้ให้เปิด Line หรือเด้งไปหน้าแชทของฟาร์มได้เลยครับ
                   alert(`สนใจรับน้อง ${pet.name} ใช่ไหมครับ? ฟีเจอร์ติดต่อฟาร์มกำลังมาเร็วๆ นี้! 🐾`); 
                }}
