...
import ScrollToTop from "./components/ScrollToTop"; // 🌟 เดี๋ยวเราสร้างไฟล์นี้แยกตามด้านล่าง

// 🌍 Metadata สำหรับ SEO (ปล่อยไว้เหมือนเดิม)
  ...
  return (
    <html lang="th">
      <body className="bg-gray-50 text-gray-900 font-sans">
        ...
        {/* 🌟 ตัวช่วยเด้งขึ้นบนสุดเวลาเปลี่ยนหน้า */}
        <ScrollToTop /> 
