    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .card-media { position: relative; z-index: 2; display: grid; grid-template-columns: 1fr 1fr; gap: 10px; padding: 6px 18px 0; }
        ...
        /* Pet ID box */
        .card-petid { position: relative; z-index: 1; margin: 4px 16px 10px; background: linear-gradient(135deg, #E84677 0%, #F472B6 100%); border-radius: 14px; padding: 10px 14px; display: flex; align-items: center; justify-content: space-between; }
        .card-petid-left { display: flex; flex-direction: column; gap: 1px; }
        .card-petid-paw-label { display: flex; align-items: center; gap: 4px; }
        .card-petid-label { font-size: 8px; font-weight: 800; color: rgba(255,255,255,0.85); letter-spacing: 0.18em; text-transform: uppercase; }
        .card-petid-num { font-family: inherit; font-size: 16px; font-weight: 900; color: white; letter-spacing: 0.5px; line-height: 1.1; }
        ...
        /* Footer */
        .card-footer { position: relative; z-index: 1; display: flex; align-items: center; justify-content: center; gap: 5px; padding: 8px 16px; border-top: 1.5px solid #FBCFE8; background: rgba(255,255,255,0.6); flex-wrap: wrap; }
              ...
              <div className="card-media">
                  ...
                  <div className="card-qr-img-wrap">
                    ...
                    <div className="card-qr-center">
                      {base64Paw && !base64Paw.startsWith('/')
                        ? <img src={base64Paw} alt="paw" style={{ width: '100%', height: '100%', objectFit: 'contain', borderRadius: '50%' }} />
                        : <PawSmall />}
                    </div>
                  </div>
                ...
                <div className="card-stamp">
                  {base64Verified && !base64Verified.startsWith('/')
                    ? <img src={base64Verified} alt="Verified" style={{ width: 84, height: 84, objectFit: 'contain', mixBlendMode: 'screen' }} />
                    : <VerifiedStamp />}
                </div>
              </div>
