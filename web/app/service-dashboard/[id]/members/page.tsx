...
const ROLES: { value: Role; label: string; desc: string }[] = [
  { value: "manager", label: "ผู้จัดการ", desc: "จัดการได้ทุกอย่าง ยกเว้นลบสถานบริการ" },
  { value: "staff",  label: "สตาฟ",   desc: "รับจอง / บันทึกข้อมูลได้" },
  { value: "viewer", label: "ผู้ดู",  desc: "ดูข้อมูลได้อย่างเดียว" },
];
const ROLE_COLOR: Record<Role, string> = { owner: "#7C3AED", manager: F.blue, staff: F.pink, viewer: F.muted };
