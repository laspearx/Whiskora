  ...
  return (
    <>
      <style>{`
        ...
        .btn-white:hover { background: #fdf0f3 !important; }
      ...
      <div style={{ color: F.ink, fontFamily: 'var(--font-ui)', paddingBottom: 0 }}>
        ...
        <section style={{ padding: '28px 0 12px' }}>
          ...
          >
            {/* Left: gradient hero */}
            <div style={{
              background: 'linear-gradient(135deg, #e84677 0%, #f06d98 60%, #f49ab8 100%)',
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 11, letterSpacing: 2, opacity: .85, marginBottom: 14, display: 'inline-flex', alignItems: 'center', gap: 8 }}>
                  <span className="pulse-dot" style={{ width: 8, height: 8, background: '#fff', borderRadius: 999, display: 'inline-block' }} />
                  WHISKORA · PLATFORM
                </div>

                <h1 style={{ fontSize: 42, fontWeight: 800, lineHeight: 1.08, letterSpacing: -1, margin: '0 0 14px', color: '#fff' }}>
                  ศูนย์กลาง<br />ทุกชีวิต<br />
                  <span style={{ background: '#fff', color: '#e84677', padding: '2px 12px', borderRadius: 12, display: 'inline-block', marginTop: 4 }}>สัตว์เลี้ยง</span>
                </h1>

                <p style={{ fontSize: 15, lineHeight: 1.6, opacity: .92, margin: 0, maxWidth: 420 }}>
                  ฟาร์มที่เชื่อถือได้ บัตร Pet ID Card ระบบสุขภาพ และบริการครบจบในที่เดียว
                </p>

                <div style={{ display: 'flex', gap: 10, marginTop: 24, flexWrap: 'wrap', position: 'relative', zIndex: 2 }}>
                  <button
                    className="btn-white"
                    style={{ background: '#fff', color: F.pink, padding: '14px 24px', borderRadius: 999, fontWeight: 700, fontSize: 15, border: 'none', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 8 }}
                  ...
                  <button
                    ...
                    style={{ background: 'rgba(255,255,255,.12)', color: '#fff', padding: '14px 24px', borderRadius: 999, fontWeight: 600, fontSize: 14, border: '1px solid rgba(255,255,255,.4)', cursor: 'pointer', backdropFilter: 'blur(8px)', display: 'inline-flex', alignItems: 'center', gap: 8 }}
