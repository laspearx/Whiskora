    ...
    <div className="space-y-8 py-6 animate-in fade-in duration-1000">
      ...
      <section className="max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <Link href="/marketplace?category=dog" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-pink-300 hover:shadow-md transition text-center group">
          ...
          <Link href="/marketplace?category=cat" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-pink-300 hover:shadow-md transition text-center group">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition duration-300">🐱</div>
            <h3 className="font-bold text-gray-800 text-base">แมว</h3>
            <p className="text-xs text-gray-500 mt-0.5">ฟาร์ม & หาบ้าน</p>
          </Link>
          <Link href="/services" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-pink-300 hover:shadow-md transition text-center group">
            <div className="text-3xl md:text-4xl mb-2 group-hover:scale-110 transition duration-300">🏥</div>
            <h3 className="font-bold text-gray-800 text-base">คลินิก</h3>
            <p className="text-xs text-gray-500 mt-0.5">รักษาสัตว์</p>
          </Link>
          <Link href="/services?type=grooming" className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 hover:border-pink-300 hover:shadow-md transition text-center group">
